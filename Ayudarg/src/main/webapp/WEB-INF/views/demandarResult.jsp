...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header" style="color:#fff;">Recursos disponibles:</h1>
			</div>
		</div>
		<!--/.row-->
		...
		<div class="row">
			<c:forEach items="${recursos}" var="element">
				<div class="col-lg-6">
						...
						<div class="panel-body">
							...
							<div class="icon-grid">
								<div class="col-md-12">
									...
									<p>Nombre: ${element.institucion.nombre}</p>
									<p>Dirección: ${element.institucion.direccion}</p>
									<p>Email: ${element.institucion.mail}</p>
									<p>Teléfono: ${element.institucion.telefono}</p>
									<p>Web: ${element.institucion.sitioWeb}</p>
								</div>
							</div>
						</div>
					</div>
