...
//        }
    	...
    	System.out.println("nos pasa el usuario:"+loginBean.getUsuario());
    	System.out.println("nos pasa la clave:"+loginBean.getContrasenia());
    	ArrayList<Usuario> todos = (ArrayList<Usuario>) serviceUsuarios.listUsuarios();

    	for(Usuario us: todos){
    		if(us.getEmail().equals(loginBean.getUsuario()) && us.getContrasenia().equals(loginBean.getContrasenia())){
    			return "dashboard";
    		}
